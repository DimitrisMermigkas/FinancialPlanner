...
export interface newOption extends Option {
  isNew?: boolean;
}
...
export interface AutocompleteVirtualizedProps<ValueType>
  extends Omit<
  ...
  >;
  getOptionDisabled?: (option: newOption) => boolean;
  onCreate?: (value: newOption) => void;
  renderOption?: (
    props: object,
    option: newOption,
...
export const renderRows = (
  ...
  >
    <Typography noWrap={true} title={(option as newOption).label}>
      {(option as newOption).label}
    </Typography>
  </li>
);
export const filteredOptionsSelect = (
  options: newOption[],
  state: FilterOptionsState<newOption>
) => {
